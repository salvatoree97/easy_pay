...
class CustomSpaceBar extends StatefulWidget {
  ...
  /// Defines how far the [background] is inset from the widget
  /// bottom-left or its center.
  final double? backgroundBottomPadding;

  /// Wraps a widget that contains an [AppBar] to convey sizing information down
  /// to the [CustomSpaceBar].
  ///
  ...
  /// [CustomSpaceBar] when fully collapsed. `maxExtent` sets the maximum
  /// height of the resulting [CustomSpaceBar] when fully expanded.
  /// `currentExtent` sets the scale of the [CustomSpaceBar.background] and
  /// [CustomSpaceBar.title] widgets of [CustomSpaceBar] upon
  /// initialization.
  ///
  /// See also:
  ///
  ///  * [FlexibleSpaceBarSettings] which creates a settings object that can be
  ///    used to specify these settings to a [CustomSpaceBar].
...
class _FlexibleSpaceBarState extends State<CustomSpaceBar> {
      ...
      builder: (BuildContext context, BoxConstraints constraints) {
        ...
        if (widget.background != null) {
          ...
          children.add(Positioned(
            ...
            left: 0.0,
            right: 0.0,
            height: height - (widget.backgroundBottomPadding ?? 0.0),
            child: Opacity(
